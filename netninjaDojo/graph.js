...
// dotted lines Group append to 'graph', opacity 0 to hide group
...
const update = (data) => {
    ...
    data.forEach(item => console.log(item.activity, activity));
    ...
    xAxisGroup.selectAll('text')
        ...
        .attr("fill","#ccc");
    yAxisGroup.selectAll('text').attr("fill","#ccc");
   ...
   // event handler for hover on data points
